...
public class DataUtils {
	 ...
	 * @return
	 */
	public static byte[] hexStringToByteReverse(String hex) {
		if (TextUtils.isEmpty(hex)) {
			return null;
		}
		hex = hex.toUpperCase();
	...
	int  getClass(int cardCode){
		if (cardCode == 1){
			return R.string.prestige_class;
		}else if (cardCode == 2){
			return R.string.vip_class;
		}else if (cardCode == 3){
			return R.string.premium_class;
		}

		return R.string.unkown_class;
	}

	public static @StringRes int  getCategory(int cardCat){
		if (cardCat == 1){
			return R.string.individual_cat;
		}else if (cardCat == 2){
			return R.string.family_cat;
		}else if (cardCat == 3){
			return R.string.fan_cat;
		}else if (cardCat == 4){
			return R.string.stadium_cat;
		}

		return R.string.unkown_cat;
	}
}
