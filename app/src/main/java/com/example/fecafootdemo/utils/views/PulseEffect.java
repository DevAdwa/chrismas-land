 ...
 */
public class PulseEffect extends RelativeLayout {
    ...
    public PulseEffect(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PulseEffect(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public PulseEffect(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
